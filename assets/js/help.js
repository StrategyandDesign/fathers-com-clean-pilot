...
(function(){
  ...
  var CONTEXT = {
    ...
    'class.html': { name: 'Fathering Fundamentals (Seven Secrets wrapper)', topics: ['session','checkpoint','practice','certificate'] },
    'course-fathering-fundamentals.html': { name: 'Fathering Fundamentals', topics: ['session','checkpoint','practice','certificate'] },
    'course-steady-under-pressure.html': { name: 'Steady Under Pressure', topics: ['session','checkpoint','practice','seat'] },
    'course-coming-home-present.html': { name: 'Coming Home Present', topics: ['session','checkpoint','practice','seat'] },
    'course-same-team.html': { name: 'Same Team', topics: ['session','checkpoint','practice','seat'] },
