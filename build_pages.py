...
<div class="rh-door">
  ...
  <main class="rh-door-main">
    ...
    <p class="rh-door-fine">Then your report. Then the films. Private and free.</p>
    <p class="rh-door-resume">Already here? <a href="login.html?path=rh">Log in</a></p>
<p class="rh-door-fine" style="margin-top:26px">All four courses are yours, free: <a href="course-coming-home-present.html">Coming Home Present</a> first, then <a href="course-steady-under-pressure.html">Steady Under Pressure</a>, <a href="course-fathering-fundamentals.html">Fathering Fundamentals</a>, and <a href="course-same-team.html">Same Team</a>.</p>
  </main>
