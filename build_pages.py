...
<section id="catalog" class="band"><div class="container">
  ...
  <div class="cert-cards" id="tracks">
    <div class="cert-card" style="cursor:default" data-cert="fundamentals" data-title="Fathering Fundamentals" data-hours="10.0" data-desc="The flagship curriculum, hardened into proof. The same lessons taught by fathers who have lived it, plus identity verification, logged time, checkpoints, and a final assessment.">
      <div class="cert-card-top"><span class="pill pill-court">Verified</span><span class="cert-card-hrs">5 sessions</span></div>
...
<p class="fine" style="color:var(--ash);max-width:62ch;margin-top:14px">Steady Under Pressure is a fathering skills course. It is not anger management, batterer intervention, domestic violence intervention, or a substitute for any court-mandated program. It is not designed or validated for those purposes and should not be ordered in their place.</p>
