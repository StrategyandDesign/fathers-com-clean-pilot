...
PAGES['profile.html'] = dict(title='The Keystone Father Profile', desc='Know where you stand. Train what matters. About twenty honest minutes.', active='Profile', mode='public', nochrome=True, body='''<div id="ksIntro" class="ks-intro">
  <div class="ks-intro-grid">
    <div class="ks-intro-copy">
      ...
      <p style="color:var(--ash);max-width:48ch;font-size:17px;line-height:1.55;margin:0 0 4px">An honest read, not a lecture. About twenty minutes. You leave with four scores you can train and a ninety-day plan built from your answers.</p>
  ...
  <div style="margin-top:28px">
    ...
    <div class="ks-after">
      ...
      <div class="ks-after-step"><div class="mono">02</div><b>Plan</b><p>A ninety-day plan with one next move you can keep.</p></div>
...
<section class="tight" style="padding-top:8px"><div class="container">
  <div class="grid-3">
    <div class="card" style="padding:22px"><div class="mono ash" style="margin-bottom:10px">01</div><b>Know where you stand</b><p class="small" style="margin-top:8px">Free Profile, about twenty minutes. Four scores and a ninety-day plan.</p></div>
...
<section id="catalog" class="band"><div class="container">
  ...
  <div class="cert-cards" id="tracks">
    ...
    <div class="cert-card" style="cursor:default" data-cert="reentry" data-title="Coming Home Present" data-hours="8.0" data-desc="Presence after time away, whatever kept you away. Self-paced film with a Certified Facilitator available for questions, checkpoints, and a certificate a court or program can trust.">
      <div class="course-card-media">
      ...
      <p>Presence after time away. The return spine: body, child, deposits, reunion. Watch on your own time. Facilitator support when claimed.</p>
      <ol class="sess-visible">
    ...
    <div class="cert-card" style="cursor:default" data-cert="anger" data-title="Steady Under Pressure" data-hours="6.0" data-desc="Steadiness, trained on film: the pause, the repair, and the habits underneath them. Self-paced, with a Certified Facilitator available for questions. Sessions logged, checkpoints, and a final assessment at eighty percent to pass.">
      <div class="course-card-media">
      ...
      <p>Steadiness on film: the pause, the repair, and the habits underneath. Self-paced. Facilitator available for questions.</p>
    ...
    <div class="cert-card" style="cursor:default" data-cert="coparenting" data-title="Same Team" data-hours="6.0" data-desc="Co-parenting, trained on film. One team for your children, whatever the arrangement between you. Self-paced, with a Certified Facilitator available for questions. Sessions logged, checkpoints, and a final assessment at eighty percent to pass.">
      <div class="course-card-media">
      ...
      <div class="cert-card-top"><span class="pill">Film course</span><span class="cert-card-hrs">6 sessions</span></div>
      <h3>Same Team</h3>
      <p>Co-parenting on film. One team for your children, whatever the arrangement. Self-paced. Facilitator available for questions.</p>
      <ol class="sess-visible">
        ...
        <li><b>The Body in Conflict</b> <span>&middot; &ldquo;Flooded means pause. Twenty minutes, then resume.&rdquo;</span></li>
        <li><b>Businesslike</b> <span>&middot; &ldquo;Short, factual, about the child.&rdquo;</span></li>
      </ol>
      <details class="sess-peek" style="margin-top:4px"><summary class="fine" style="cursor:pointer;color:var(--brass,#c9a227)">All 6 sessions</summary><ol class="small" style="margin:8px 0 2px;padding-left:18px"><li style="margin:5px 0"><b>One Team for the Children</b> <span style="color:var(--ash)">&middot; &ldquo;Whatever we are to each other, we are one team for the child.&rdquo;</span></li><li style="margin:5px 0"><b>The Body in Conflict</b> <span style="color:var(--ash)">&middot; &ldquo;Flooded means pause. Twenty minutes, then resume.&rdquo;</span></li><li style="margin:5px 0"><b>Businesslike</b> <span style="color:var(--ash)">&middot; &ldquo;Short, factual, about the child.&rdquo;</span></li><li style="margin:5px 0"><b>Earning Back Trust</b> <span style="color:var(--ash)">&middot; &ldquo;Trust is bought with reliability, and never against an order.&rdquo;</span></li><li style="margin:5px 0"><b>One Child, Two Homes</b> <span style="color:var(--ash)">&middot; &ldquo;The child carries the distance. Lighten the load.&rdquo;</span></li><li style="margin:5px 0"><b>The Handoff</b> <span style="color:var(--ash)">&middot; &ldquo;Predictable beats perfect.&rdquo;</span></li></ol><p class="fine" style="margin:6px 0 0"><a class="link" href="course-same-team.html">Open the course &rarr;</a></p></details>
