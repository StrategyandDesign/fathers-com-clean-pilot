  ...
  <div class="grid-3" id="homeclasses" style="margin-top:6px">
    ...
    <a class="card" href="course-steady-under-pressure.html" style="padding:0;overflow:hidden;text-decoration:none">
      ...
      <div style="padding:20px 22px">
        ...
        <p class="fine" style="color:var(--ash)">A man&rsquo;s temper, trained. All six written sessions are live; films are in production.</p>
      </div>
    </a>
...
<section id="catalog" class="band"><div class="container">
  ...
  <div class="cert-cards" id="tracks">
    <a class="cert-card" href="enroll.html?cert=fundamentals&amp;title=Fathering%20Fundamentals&amp;hours=10.0" data-cert="fundamentals" data-title="Fathering Fundamentals" data-hours="10.0" data-desc="The flagship curriculum, hardened into proof. The same lessons taught by fathers who have lived it, plus identity verification, logged time, checkpoints, and a final assessment.">
      ...
      <div class="cert-card-top"><span class="pill">Sessions live</span><span class="cert-card-hrs">8.0 hrs</span></div>
      ...
      <div class="cert-card-foot"><span class="mono">8 sessions</span><a class="cert-card-go" href="course-coming-home-present.html">Read the sessions &rarr;</a></div>
    </div>
    <div class="cert-card" style="cursor:default" data-cert="anger" data-title="Steady Under Pressure" data-hours="6.0" data-desc="A man&rsquo;s temper, trained. The pause, the repair, and the steadiness the people around you can feel. Verified hours, identity checked, checkpoints, and a final assessment at eighty percent to pass.">
      <div class="cert-card-top"><span class="pill">Sessions live</span><span class="cert-card-hrs">6.0 hrs</span></div>
      <h3>Steady Under Pressure</h3>
      <p>A man&rsquo;s temper, trained: the pause, the repair, and the steadiness the people around you can feel. All six written sessions are published; films are in production.</p>
      <div class="cert-card-foot"><span class="mono">6 sessions</span><a class="cert-card-go" href="course-steady-under-pressure.html">Read the sessions &rarr;</a></div>
    </div>
    <div class="cert-card" style="cursor:default" data-cert="coparenting" data-title="Same Team" data-hours="6.0" data-desc="Co-parenting, trained. One team for your children, whatever the arrangement between you. Verified hours, checkpoints, and a final assessment at eighty percent to pass.">
      <div class="cert-card-top"><span class="pill">Sessions live</span><span class="cert-card-hrs">6.0 hrs</span></div>
      <h3>Same Team</h3>
      ...
      <div class="cert-card-foot"><span class="mono">6 sessions</span><a class="cert-card-go" href="course-same-team.html">Read the sessions &rarr;</a></div>
    </div>
      </div>
...
<div style="min-height:100vh;display:flex;flex-direction:column;align-items:center;padding:64px 20px">
  ...
  <div style="width:100%;max-width:520px">
    ...
    <p class="fine" style="margin-top:32px">Every certificate carries a serial in the format FC-2026-######. If a serial does not resolve here, it is not a Fathers.com certificate.</p>
  </div>
</div>
''')
...
<section style="background:#0B0B0B;color:#F5F1E8;padding:64px 0"><div class="container split" style="gap:56px">
  ...
  <div class="grid-2" style="gap:32px">
    ...
    <div><p class="fine mono" style="color:#C9A227;margin-bottom:8px">THE STANDARD</p><p class="small" style="color:#F5F1E8">Baseline and exit on a research-based instrument. Movement per cohort, benchmarked against established norms. A renewal that is a number.</p></div>
  </div>
</div></section>
...
<header class="hero"><div class="container" style="max-width:860px">
  ...
  <p class="lead" style="margin:22px 0 8px">The Keystone Father Profile is a research-based, versioned instrument grown from the Personal Fathering Profile research program of Dr. Ken Canfield and normed on thousands of fathers. It is the spine of everything on this platform.</p>
</div></header>
