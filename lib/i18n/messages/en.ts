export const en = {
  ...
  auth: {
    ...
    orgContinue: "Continue with your organization",
    orgContinueLead:
      "Leaders and Reviewers can use single sign-on when Super-admin turns sso_enabled on. Fathers still join with an invite code. Super-admin keeps email and password.",
    orgContinueEmail: "Work email",
    revoked: "This desk access has been revoked.",
  },
  flash: {
  ...
  fidelity: {
    ...
    lead: "A living supervision list for a cohort week. Education only. Not a clinical chart.",
    deskTitle: "Fidelity and team",
    deskLead: "Complete the supervision checklist, or record a Certified Facilitator attestation.",
    teamSummary: "Team",
    teamLead: "Fidelity checklist and Certified Facilitator registry. Exam can stay offline. This records attestation only.",
    openBoard: "Open fidelity checklist",
    openRegistry: "Open facilitator registry",
    backList: "Back to fidelity",
    backAccount: "Back to Account",
    flagOffTitle: "This board is off",
    flagOffBody: "The prior desk is unchanged. Super-admin can turn fidelity_board_enabled on.",
    emptyTitle: "No cohort yet",
    emptyBody: "Create a group, then open the checklist for that cohort or a training.",
    emptyAction: "Back to Dashboard",
    notReadyTitle: "Checklist not ready",
    notReadyBody: "The fidelity tables are not on this desk yet.",
    progress: "{completed} of {total} complete",
    boardCohortLead: "Supervision checklist for {group}. Complete items as the cohort week happens.",
    boardTrainingLead: "Supervision checklist for {training} in {group}.",
    sectionSessionOne: "Session one",
    sectionMidCohort: "Mid-cohort (session three)",
    sectionTheFinal: "The final",
    sectionCredential: "Credential decision",
    markComplete: "Mark complete",
    markCompleteOn: "Complete",
    saveItem: "Save",
    clearItem: "Clear",
    notes: "Short note",
    notesHint: "One coaching note. Keep it short.",
    completedBy: "Completed by {name} on {date}",
    downloadSummary: "Download Quality Improvement summary",
    downloadRegistry: "Download facilitator credentials",
    exportHint: "Quality Improvement packet hooks. You download these. A person still confirms any outbound send.",
    registryTitle: "Certified Facilitator registry",
    registryLead:
      "Attestation only. The exam can stay offline. This is not a clinical license and not a staff learning system.",
    registryEmptyTitle: "No leaders on this desk",
    registryEmptyBody: "Add a leader to the organization, then record their status here.",
    credentialStatus: "Status",
    credentialTraining: "In training",
    credentialCertified: "Certified",
    credentialSuspended: "Suspended",
    earnedOn: "Earned on",
    evidence: "Evidence path",
    evidenceHint: "Offline exam note or a short file path.",
  ...
  trust: {
    ...
    ssoComing: "Off unless Super-admin turns sso_enabled on.",
    ssoOff: "Off unless Super-admin turns sso_enabled on.",
    ssoConnected: "Connected",
    ssoConnectedNote: "Identity provider: {name}.",
    ssoConnectedNoteGeneric: "An identity provider is connected.",
    openSecurity: "Open sign-in security",
    packLabel: "Business Associate Agreement and education-only pack",
    packDrafts: "Drafts available.",
    packChecklist: "Requirement on. Checklist is still open.",
    packAttached: "Attached mark on file. Downloads stay drafts.",
    packNeverExecuted: "Not an executed agreement.",
    openCounsel: "Open counsel pack",
  ...
  identity: {
    ...
    accountLead:
      "Read-only single sign-on status for your organization. Super-admin configures the identity provider.",
    open: "Open sign-in security",
    backAccount: "Back to Account",
    backOrg: "Back to organization",
    flagOff: "sso_enabled is off. Staff keep email and password.",
    flagOn: "sso_enabled is on.",
    notConfigured: "No identity provider is linked yet.",
    protocol: "Protocol",
    issuer: "Issuer",
    roleMap: "Role claim map",
    lastDeprovision: "Last deprovision",
    lastDeprovisionNone: "No deprovision recorded yet.",
  ...
  father: {
    ...
    session: {
      ...
      filmNextHint:
        "When you have the teaching, continue to the question. Then one skill.",
      ...
      whenWillYou: "When will you try this?",
      ...
      lockItIn: "Save and move on",
      skipForNow: "Back to dashboard",
      iDidIt: "I did it",
      changeMoment: "Change when",
    ...
    start: {
      ...
      welcomeBody:
        "This is a place to pick up skills you can use at home. A short film, one question, and one thing to try. A few minutes at a time.",
  ...
  manager: {
    dashboard: {
      ...
      cadenceTitle: "Review cadence",
      cadenceLead:
        "Open items are men mid-work. Pending actions wait on you. Certificates ready are proofs you can send.",
      cadenceOpen: "Open items",
      cadenceOpenHint: "A session is still open, or he has no assigned training.",
      cadencePending: "Pending actions",
      cadencePendingHint: "A review or a certificate is waiting on you.",
      cadenceCertificates: "Certificates ready",
      cadenceCertificatesHint: "A finished training you can preview and send.",
      pendingWaiting: "Waiting on you",
      pendingWaitingLead: "A review or a certificate. Open the row to do the work.",
      pendingEmpty: "No review or certificate is waiting on you.",
      pendingReview: "Open review",
      pendingCert: "Open certificate",
      inviteTitle: "Group invite code",
      inviteLead: "Fathers enter this code when they create an account.",
      groupName: "Group name",
      createGroup: "Create group",
      attention: "Open items",
      attentionLead: "Sessions still open, or no training assigned.",
      caughtUp: "Nothing waiting",
      caughtUpBody: "No open sessions, and no man without assigned training.",
    ...
    companion: {
      ...
      reasonPracticeSkipped: "Practice skipped",
    ...
    considerNext: {
      title: "Consider next",
      lead: "One suggested next step for each man. Nothing sends or issues until you confirm.",
      empty: "No one needs a next step right now.",
      emptyBody: "Quiet men, skipped practice, ready certificates, and stalled assessments will show here.",
      youConfirm: "You still confirm before anything is sent or issued.",
      confirmCert: "Preview certificate",
      confirmOpen: "Open this man",
      reasonCert: "Ready for a certificate: {title}",
      reasonAssessment: "Assessment still in progress: {title}",
      reasonKeystone: "Keystone still in progress",
      reasonOpen: "An open item is waiting on this man.",
    },
    participants: {
      title: "Participants",
      ...
      practiceNotYet: "Practice not yet",
      practiceDismissed: "Practice dismissed",
      practiceStale: "Practice stale",
    ...
    bulk: {
      ...
      quiet: "Quiet",
      nextAction: "Next",
      nextCertificate: "Certificate ready: {title}",
